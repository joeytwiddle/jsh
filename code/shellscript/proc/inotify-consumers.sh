...
# Also: https://stackoverflow.com/questions/13758877/how-do-i-find-out-what-inotify-watches-have-been-registered
# Similar app, native executable, faster and with more options: https://github.com/mikesart/inotify-info
#
#
########################################## Notice ##########################################
