...
SEARCHDIRS="/stuff/mp3s/ /stuff/mirrors/ /mnt/big/winmxdownloads/ /mnt/big/mutella_downloads/ /mnt/big/bittorrent_downloads/got /mnt/big/out /mnt/big/toconsume /mnt/big/gone_consume /mnt/big/consume_then_write/music /mnt/big/gtk-gnutella_downloads"

find $SEARCHDIRS -iname "*.mp3" -or -iname "*.ogg" -not -size 0 |
