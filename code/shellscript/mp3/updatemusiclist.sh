...
SEARCHDIRS="/stuff/mp3s/ /stuff/mirrors/ /mnt/big/winmxdownloads/ /mnt/big/mutella_downloads/ /mnt/big/bittorrent_downloads/got /mnt/big/out /mnt/big/toconsume /mnt/big/gone_consume /mnt/big/consume_then_write/music"
