...
find /stuff/mp3s/ /stuff/mirrors/ /mnt/big/winmxdownloads/ /mnt/big/mutella_downloads/ /mnt/big/bittorrent_downloads/got /mnt/big/out /mnt/big/toconsume /mnt/big/gone_consume -iname "*.mp3" -or -iname "*.ogg" -not -size 0 |
