# For scp:
# PS1="\[\033[00;36m\]\u\[\033[00m\]@\[\033[00;36m\]\h\[\033[00;39m\]:\[\033[00;32m\]\w/\[\033[00m\] "
# \[\033[00;36m\]\t\[\033[00m\]
...
if test `hostname` = "panic"; then
  PS1='\['`curseyellow`'\]\!\['`cursered``cursebold`'\]\$\['`cursegrey`'\]/\['`cursemagenta`'\]\u\['`cursegrey`'\] \['`curseblue`'\]\t\['`cursegrey`'\] \['`cursemagenta`'\]\h\['`cursegrey`'\]\\\\\['`cursegreen`'\]\w\\\\\['`cursegrey`'\] '
  # magenta style, panic colors PS1="\[\033[00;33m\]\!\[\033[01;31m\]\$ \[\033[00;35m\]\u\[\033[01m\]\\\\\[\033[00;34m\]\t\[\033[01m\]/\[\033[01;35m\]\h \[\033[00;32m\]\w/\[\033[01m\] "
fi
